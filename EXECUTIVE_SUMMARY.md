...
|-----------|---------|--------|------------|
| **Hub Repository** | 2.17.1 | ✅ Production | 19 skill collections, HUB_MAP routing, CIH-ROADMAP |
| **Jimmy Core Preferences** | 2.1.1 | ✅ Production | Global cross-agent framework, prompt governance, Documentation Language Standard, hybrid session governance, curator-only daily reports, project status summary standard, DAX overlay |
...
**1. jimmy-core-preferences (v2.1.1)**
...
|------------|-------|------|-----------|---------|--------|
| jimmy-core-preferences | 5 | ~80KB | ✅ Yes | v2.1.1 | ✅ Production |
