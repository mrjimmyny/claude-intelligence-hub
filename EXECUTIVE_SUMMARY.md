...
|-----------|---------|--------|------------|
| **Hub Repository** | 2.18.0 | ✅ Production | 19 skill collections, HUB_MAP routing, CIH-ROADMAP |
| **Jimmy Core Preferences** | 2.2.0 | ✅ Production | Global cross-agent framework, prompt governance, Documentation Language Standard, hybrid session governance, curator-only daily reports, project status summary standard, DAX overlay, AOP dispatch guardrails |
...
**1. jimmy-core-preferences (v2.2.0)**
...
|------------|-------|------|-----------|---------|--------|
| jimmy-core-preferences | 5 | ~80KB | ✅ Yes | v2.2.0 | ✅ Production |
