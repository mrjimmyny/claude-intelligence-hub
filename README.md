...
|------------|---------|--------|-------------|--------------|
| **[jimmy-core-preferences](jimmy-core-preferences/)** | v2.0.1 | ✅ Production | Global cross-agent operating framework | Radical honesty, prompt governance, hybrid session governance, DAX overlay, cross-agent bootstrap. See [HUB_MAP.md](HUB_MAP.md) for triggers. |  
...
claude-intelligence-hub/
│
├── 📁 jimmy-core-preferences/       # ⭐ Global Cross-Agent Framework (v2.0.1)
