...
[![Version](https://img.shields.io/badge/version-2.23.2-blue.svg)](CHANGELOG.md)
...
claude-intelligence-hub/
│
├── 📁 jimmy-core-preferences/       # ⭐ Global Cross-Agent Framework (v3.3.0)
...
│
├── 📁 daily-doc-information/         # ⭐ Daily Documentation Information (v1.5.0)
