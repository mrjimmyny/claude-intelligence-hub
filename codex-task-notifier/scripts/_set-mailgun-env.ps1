...
[System.Environment]::SetEnvironmentVariable('CTN_MAILGUN_DOMAIN',   'mg.mrjimmyny.org',          'User')
[System.Environment]::SetEnvironmentVariable('CTN_MAILGUN_FROM',      'notify@mg.mrjimmyny.org',   'User')
